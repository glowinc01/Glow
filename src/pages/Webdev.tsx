    ...
    <div className="flex items-center justify-center flex-col w-full">
      <div className="flex items-center justify-center bg-[#001F3F] w-full h-[300px]">
        <div className="flex items-center justify-center bg-[#001F3F] w-[90] flex-col">
          <h1 className=" font-poppins font-bold text-[28px] lg:text-[35px] text-center">
            Web <br /> Development
          </h1>
          <p className="font-inter font-medium text-[10px] lg:text-[16px] text-[#FFFFFF] text-center mt-2">
